...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-plus-circle"></i> States</h6>
            <div class="ml-auto">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('backend.state.store') }}" method="post" enctype="multipart/form-data"
                  autocomplete="off">
                @csrf
                <div class="row">
                    <div class="col-6">
                    ...
                    <div class="col-12">
                        ...
                        <select name="country_id" id="country_id" class="form-control select-2">
                            ...
                            @forelse($countries as $item)
                                <option value="{{ $item->id }}" {{ old('country_id') == $item->id ? 'selected' : NULL }}>{{ $item->name }}</option>
                            @empty
                            @endforelse
                        </select>
