...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-edit"></i> Countries</h6>
            <div class="ml-auto">
                <a href="{{ route('backend.country.index') }}" class="btn btn-primary btn-sm">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('backend.country.update',$country->id) }}" method="post"
                ...
                <div class="form-group pt-4">
                    <button type="submit" name="submit" class="btn btn-primary">
                        ...
                        <span class="text">Edit Country</span>
                    </button>
                </div>
            </form>
