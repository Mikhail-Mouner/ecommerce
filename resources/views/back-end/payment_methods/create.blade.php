...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-plus-circle"></i> Payment Methods</h6>
            <div class="ml-auto">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('backend.payment_method.store') }}" method="post" enctype="multipart/form-data"
                  autocomplete="off">
                @csrf
                <div class="row">
                    ...
                    @foreach($form_iputs as $input)
                        <div class="{{ $input['col'] }}">
                            <div class="form-group">
                                ...
                                <input type="{{ $input['type'] }}" name="{{ $input['prefix'] }}" value="{{ old($input['prefix']) }}" class="form-control">
