...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-user-plus"></i> Supervisor</h6>
            <div class="ml-auto">
                    ...
                    <div class="col-12">
                        ...
                        <select name="permissions[]" id="permissions" multiple="multiple" class="form-control select-2">
                            ...
                            @foreach($permissions as $item)
                                <option value="{{ $item->id }}" {{ old('permissions') && in_array($item->id,old('permissions'))  ? 'selected' : NULL }}>{{ $item->name }}</option>
                            @endforeach
                        </select>
                ...
                <div class="row pt-4">
                    <div class="col-12">
                        ...
                        <div class="file-loading">
                            <input type="file" name="user_image" id="user-image-image" class="file-input-overview">
