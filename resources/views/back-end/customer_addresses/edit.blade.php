...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-edit"></i> Customer Address</h6>
            <div class="ml-auto">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('backend.customer_address.update',$customer_address->id) }}" method="post" enctype="multipart/form-data"
                  autocomplete="off">
                @csrf
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input readonly type="text" class="form-control typeahead"
                                   name="customer"
                                   id="customer"
                                   value="{{ old('customer',$customer_address->user->full_name.' '.$customer_address->user->email) }}"
                                   data-provide="typeahead">
                            <input name="user_id" id="user_id" type="hidden" value="{{ old('user_id',$customer_address->user->id) }}">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="address_title" value="{{ old('address_title',$customer_address->address_title) }}"
                                   class="form-control">
                            @error('address_title')
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="email" name="email" value="{{ old('email',$customer_address->email) }}" class="form-control">
                            @error('email')
                            <div class="text-danger">{{ $message }}</div>@enderror
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="tel" name="mobile" value="{{ old('mobile',$customer_address->mobile) }}" class="form-control">
                            @error('mobile')
                            <div class="text-danger">{{ $message }}</div>@enderror
                        </div>
                    </div>
                ...
                <div class="form-group pt-4">
                    <button type="submit" name="submit" class="btn btn-primary">
                        ...
                        <span class="text">Edit Address</span>
                    </button>
                </div>
            </form>
...
@push('script')
    ...
    <script>
        ...
        function populateStates() {
            let country_id_val = $('#country_id').val() != null ? $('#country_id').val() : '{{ old('country_id',$customer_address->country_id) }}'
