<div class="card-body">
    <form action="{{ route('backend.customer_address.index') }}" method="get" autocomplete="off">
        <div class="row">
            <div class="col-3">
            ...
            <div class="col-2">
                <div class="form-group">
                    <select name="status" class="form-control">
                        <option value="">---</option>
                        <option value="1" {{ old('status', request()->input('status')) == 1 ? 'selected' : '' }}>Default</option>
                        <option value="0" {{ old('status', request()->input('status')) == 0 && old('status', request()->input('status')) != NULL ? 'selected' : '' }}>Additional</option>
                    </select>
                </div>
            </div>
            <div class="col-2">
