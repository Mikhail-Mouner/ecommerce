<div class="card-body">
    <form action="{{ route('backend.supervisor.index') }}" method="get" autocomplete="off">
        <div class="row">
            <div class="col-3">
            ...
            <div class="col-2">
                <div class="form-group">
                    <select name="status" class="form-control">
                        ...
                        <option value="0" {{ old('status', request()->input('status')) == 0 && old('status', request()->input('status')) != NULL ? 'selected' : '' }}>
                            Inactive
                        </option>
                    </select>
                </div>
