            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>{{ $order->ref_id }}</td>
                        <th>Customer</th>
                        <td><a href="{{ route('backend.customer.show', $order->user_id) }}">{{ $order->user->full_name }}</a></td>
                    </tr>
                    <tr>
                        <th>Address</th>
                        <td><a href="{{ route('backend.customer_address.show', $order->user_address_id) }}">{{ $order->user_address->address_title??null }}</a></td>
